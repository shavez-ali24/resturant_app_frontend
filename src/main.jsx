...
const RouteFallback = () => {
  ...
  return (
    <div
      className={`flex min-h-screen items-center justify-center ${isDarkMode ? "bg-slate-950 text-slate-200" : "bg-white text-gray-600"
        }`}
    >
      <div
        className={`flex items-center gap-3 rounded-xl border px-4 py-3 shadow-sm ${isDarkMode
