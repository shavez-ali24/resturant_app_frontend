      ...
      {orderedCategoryKeys.map((category) => {
        ...
        const containerClass =
          layoutMode === "multi"
            ...
            : `grid items-start gap-3 ${layoutMode === "single"
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        className={`relative cursor-pointer overflow-hidden ${layoutMode === "single"
                      ...
                      >
                        {/* Item Name with Pencil Icon */}
                        <h3
                          className={`flex items-start justify-between leading-tight text-gray-900 ${layoutMode === "single"
      ...
      {typeof document !== "undefined" && createPortal(
        <AnimatePresence>
          {descModal.open && descModal.item && (
            ...
            >
              <motion.div
                className={`relative flex max-h-[90vh] w-full max-w-md flex-col overflow-hidden rounded-3xl border shadow-2xl ${isDarkMode
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <button
                    onClick={closeDescription}
                    className={`absolute top-4 right-4 h-9 w-9 flex items-center justify-center rounded-full shadow-md transition ${isDarkMode
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-center gap-2">
                    {descModal.item.category && (
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${isDarkMode ? "bg-slate-900/90 text-slate-100 border border-slate-600" : "bg-white text-gray-800"
                        }`}>
                        {descModal.item.category}
                      </span>
                    )}
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-4">
                  ...
                  <div
                    className={`rounded-2xl border p-3 shadow-sm ${isDarkMode
                  ...
                  >
                    <div className="space-y-2">
                      {(() => {
                        ...
                        const renderPriceLine = (label, originalPrice, finalPrice, discountLabel, key) => (
                          <div
                            key={key || label}
                            className={`flex items-center justify-between gap-1.5 border-b pb-1.5 last:border-b-0 last:pb-0 ${isDarkMode ? "border-slate-700" : "border-orange-100/80"
                              }`}
                          >
                    ...
                    <div className="mt-2 flex flex-wrap items-center gap-2">
                      {!descModal.item.available && (
                        <span className={`text-xs font-medium px-3 py-1 rounded-full border ${isDarkMode
                  ...
                  {descModal.item.ingredients?.length ? (
                    <div className={`rounded-2xl p-4 border ${isDarkMode ? "bg-slate-900/80 border-slate-700" : "bg-gray-50 border-gray-100"
                      }`}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {descModal.item.ingredients.map((ingredient, index) => (
                          <span
                            key={index}
                            className={`px-3 py-1 rounded-full border text-xs ${isDarkMode
      ...
      {typeof document !== "undefined" && createPortal(
        <AnimatePresence>
          {customizationModal.open && (
            ...
            >
              <motion.div
                className={`relative w-full max-w-[390px] overflow-hidden rounded-3xl border shadow-2xl ${isDarkMode
                    ? "border-slate-700 bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800"
                ...
                <div className="p-5 space-y-4 sm:p-6">
                  ...
                  <div className="space-y-2">
                    <textarea
                      ...
                      className={`w-full resize-none rounded-xl border px-4 py-3 text-sm shadow-sm outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/20 ${isDarkMode
                  ...
                  <div className="flex items-center justify-end gap-3 pt-2">
                    <Button
                      ...
                      variant="outline"
                      onClick={closeCustomization}
                      className={`rounded-full px-6 ${isDarkMode
