                    ...
                    <div className="flex gap-1.5 flex-wrap justify-center sm:justify-end">
                        {showStaffButton && isAdmin && (
                            <Button
                                ...
                                className="h-8 text-xs px-3 shadow-sm transition-all duration-150 hover:bg-[var(--hover-bg)]"
                                style={btnStyle}
                            >
                    ...
                    >
                        ...
                        >
                            <Button
                                onClick={() => setShowLogoutConfirm(false)}
                                variant="outline"
                                className="h-10 flex-1 rounded-xl border text-sm font-semibold transition-colors hover:bg-[var(--hover-bg)]"
