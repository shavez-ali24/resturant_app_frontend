...
const CompletedOrders = () => {
  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col bg-gradient-to-br from-orange-50/40 via-orange-50/10 to-amber-50/30 sm:px-2 lg:px-2">
      <div data-tour="completed-heading" className="mx-2 mb-2 mt-2 flex flex-shrink-0 flex-col gap-3 rounded-2xl border border-orange-100 bg-white/95 p-3 shadow-[0_14px_32px_-22px_rgba(249,115,22,0.45)] sm:mx-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div data-tour="completed-table" className="mx-2 mt-2 flex-1 overflow-auto rounded-2xl border border-orange-100 bg-white/95 shadow-[0_14px_32px_-22px_rgba(249,115,22,0.45)] dark:border-slate-700 dark:bg-slate-900/95 dark:shadow-none sm:mx-4">
        <OrdersTable
          orders={orders}
          loading={isLoading}
          error={isError}
